...
from socialdetector.dataset_generator import ParSine
...
class MyCNNJpeg(StreamModel):
    ...
    def get_stream_model(self, input_img):
        ...
        #layer = ParSine()(layer)
        #layer = BatchNormalization()(layer)
        #layer = Conv2D(5, (5, 1), (1, 1), activation=self.conv_activation)(layer)
        #layer = MaxPooling2D((2, 2), data_format='channels_first')(layer)
        #layer = Conv2D(256, (3, 3), activation=self.conv_activation, padding=self.padding,
        #               data_format='channels_first')(layer)
        #layer = BatchNormalization()(layer)
        #layer = MaxPooling2D((2,2), data_format='channels_first')(layer)
