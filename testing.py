...
def test_noiseprintonly():
    path = r".\history\ucid_public\two_streams_1302\1611184068.0265422_std\e21-l0.1576.h5"
...
def test_myjpeg():
    path = r".\history\ucid_public\my_jpeg_1302\1611182640.530463_std\e22-l252.5046.h5"
